...
# A1a:
class country:
    def __init__(self, name, continent, climate, language, currency):
        self.name = name
...
France = country("France", "Europe", "warm", "French", "Euro")
print(France.continent)
print(France.climate)
print(France.language)
print(France.currency)
print("\nQ1b\n")
...
# A1b:
class city(country):
    def __init__(self, city_name, name, continent, climate, language, currency):
        super().__init__(name, continent, climate, language, currency)
        self.city_name = city_name


p = city("Paris", "France", "Europe", "Warm", "French", "euro")
print(p.city_name)
print(p.currency)
print(p.climate)
# -------------------------------------------------------------------------------------- #
...
for i in range(0, len(list_of_numbers)):
    if Number(list_of_numbers[i]).is_prime():
        primes.append(list_of_numbers[i])
...
factor_of_twelve = []
for i in range(0, len(list_of_numbers)):
    if Number(list_of_numbers[i]).divisible_by_n(12):
        factor_of_twelve.append(list_of_numbers[i])

print(factor_of_twelve)
# A2b:
...
a = GoodBoss("Jeff", "Evil", "Pervy", "unlikeable")
print(a.name)
